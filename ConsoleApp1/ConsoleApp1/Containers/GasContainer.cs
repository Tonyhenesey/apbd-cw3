...
public class GasContainer : Container , IHazardNotifer
{
    ...
    public GasContainer(int serialNumber,double pressure, double height, double selfWeight, double depth, double cargoWeight, LoadType loadType) : base(serialNumber, height, selfWeight, depth, cargoWeight, loadType)
    {
        _loadType = loadType;
